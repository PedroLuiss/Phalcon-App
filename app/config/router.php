...
// Product Routes
// $router->add('/article/create', ['controller' => 'product', 'action' => 'create']);
// $router->add('/article/create/submit', ['controller' => 'product', 'action' => 'createSubmit']);
// $router->add('/product/index', ['controller' => 'product', 'action' => 'index']);
// $router->add('/article/edit', ['controller' => 'product', 'action' => 'edit']);
// $router->add('/article/edit/submit', ['controller' => 'product', 'action' => 'editSubmit']);
// $router->add('/article/delete', ['controller' => 'product', 'action' => 'delete']);
